...
export const storyScenes: StoryScene[] = [
  // Prologue - The Nightmares Begin
  {
    ...
    text: "Twenty years have passed since the night that changed everything. You were just a child when the flames consumed your village, when screams pierced the darkness, when your world crumbled to ash.",
